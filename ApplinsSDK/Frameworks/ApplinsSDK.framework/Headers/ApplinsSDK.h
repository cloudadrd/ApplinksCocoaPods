...
//  ALSManager.h
//  ApplinsSDK
//  You should call [[ApplinsSDK shareManager] loadRequestGetALSSDKConfigBySlot_id:@"slotID"] in didFinishLaunchingWithOptions Method
...
/**
 ...
 @return returns a global instance of ApplinsSDK
 */
