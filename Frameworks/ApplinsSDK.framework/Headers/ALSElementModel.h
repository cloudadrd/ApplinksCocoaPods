...
#import "ALSNativeModelDelegate.h"
@class ALSElementAdListModel;

@interface ALSElementModel : NSObject
@property (nonatomic, strong)NSArray<ALSElementAdListModel *> *ad_list;
@property (nonatomic, strong)NSString *err_msg;
@property (nonatomic, assign)NSInteger err_no;
@end

@interface ALSNativeAdModel : NSObject

@property (nonatomic, strong)NSString *title;
@property (nonatomic, strong)NSString *icon; //icon url
@property (nonatomic, strong)NSString *image; //big image url
@property (nonatomic, strong)UIImage *iconImage;//icon image ,only for preloadNativeAD interface
@property (nonatomic, strong)UIImage *AdImage; //Ad big image, only for preloadNativeAD interface
...
@property (nonatomic, weak)id <ALSNativeModelDelegate> delegate;
@end

@interface ALSCustomColor : NSObject
